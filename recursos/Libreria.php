...
abstract class Libreria {
    static function getMenu($tipo=1){  # Generamos el MENU de opciones
        $menuAdmin= array(
            array(
                'icono'=>'user',
                'enlace'=>'ctrl=CtrlUsuario1',
                'texto'=>'USUARIOS'
                
            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlAgente',
                'texto'=>'Agente'

            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlBancos',
                'texto'=>'Bancos'
            
            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlcuentasUsuario',
                'texto'=>'Cuentas de Usuario'
                
            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlEmpresa',
                'texto'=>'Empresa'

            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlTipoTransaccion',
                'texto'=>'Tipo de Transaccion'
            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlTipoUsuario',
                'texto'=>'Tipo de Usuario'
            
            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlVoucher',
                'texto'=>'Voucher'
            )
        );
        $menuCliente= array(
            ...
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlUsuario&accion=verSaldo',
                'texto'=>'Ver saldo'
                
            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlCliente&accion=cambarContraseña',
                'texto'=>'Consulta de Movimientos'
            ),
            array(
                'icono'=>'table',
                'enlace'=>'ctrl=CtrlCliente&accion=cambarContraseña',
